...
const pages = [
  ...
  // ── 00  Ознакомление ──────────────────────────────────────────────────────
  {
    title: "Ознакомление",
    tag: "Введение",
    intro: "Желательно проводить проверку по тому, как расставлены программы. Если нашли ошибки или хотите что-то добавить — пишите автору: <strong>iqxpeax</strong>.",
    ...
    page.innerHTML = `
      ...
      <div class="page-footer">
        ...
        <div class="page-footer-links">
          ...
          <a href="./LICENSE" target="_blank">Лицензия</a>
        </div>
      </div>
    `;
